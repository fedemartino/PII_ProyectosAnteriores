...
namespace PicfilLib
{
    ...
    public class PictureFormRenderer : IPictureRenderer
    {
        ...
        public void Render(IPicture picture)
        {
            ...
            RunRenderer(new Renderer(GetBitmap(picture), destination, main));
        }
        ...
        public void Render(IPicture picture, Int32 x, Int32 y)
        {
            ...
            RunRenderer(new Renderer(new Point(x, y), GetBitmap(picture), destination,main));            
        }
        ...
        public class Renderer
        {
            ...
            public Renderer(Point origin, Bitmap bitmap, FormBoard destination, Form main)
            {
                this.origin = origin;
                this.bitmap = bitmap;
                this.destination = destination;
            ...
            public Renderer(Bitmap bitmap, FormBoard destination, Form main)
                : this(new Point(0,0), bitmap, destination, main)
            {                
            }
