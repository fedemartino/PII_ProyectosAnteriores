...
namespace UcuLifeLib
{
    ...
    sealed class GuiExecutor: IExecutor
    {
        ...
        private void RunAction(IAction action)
        {
            ...
            {
                // poner breakpoint aqui si se quiere capturar la 
                // excepcion lanzada por la accion al ser ejecutada por 
                // el ejecutor
                throw new Exception("Exception when running IAction: " + e.Message +
                    "\n at " + e.TargetSite.ToString());
            }
        }
